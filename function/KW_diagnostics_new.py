...
###########################################################
def plot_raw_spectrum(power_V, x, y, clev, cticks, fig_dir, vname, icase, CASE_SHORT, sym_asy_background=0): 
    # vname = 'precip'
    # icase = 0:-4K, 1:CTL, 2:+4K
    # CASESHORT = 'CTL_20y'
    # sym_asy = 0 or 1 or 2 (sym:0, asy:1, background:2)
    ...
    if sym_asy_background == 0:
        sym_str = 'sym'
    elif sym_asy_background == 1:
        sym_str = 'asy'
    elif sym_asy_background == 2:
        sym_str = 'background'
    ...
    plt.title('Raw power (log)-'+sym_str+': '+vname+', '+CASE_SHORT)
    #
    ...
    plt.savefig(fig_dir+vname+'_raw_'+sym_str+'_'+CASE_SHORT+'.png')
    plt.show()
    plt.close()                   

###################################################################
def plot_signal_strength(r_sym, x, y, clev, cticks, fig_dir, vname, icase, CASE_SHORT, sym_asy=0): 
    ...
    if sym_asy == 0:
        ...
        print('asy')
    #
    plt.title('Signal stregnth-'+sym_str+': '+vname+', '+CASE_SHORT)
    plt.ylabel('frequency')
    plt.xlabel('zonal wavenumber')
    plt.axis([-15,15,0,0.5])
    plt.xticks([-15,-10,-5,0,5,10,15])
    plt.yticks(np.arange(0,0.55,0.05))
    plt.savefig(fig_dir+vname+'_r'+sym_str+'_'+CASE_SHORT+'.png')
    plt.show()
    plt.close() 
